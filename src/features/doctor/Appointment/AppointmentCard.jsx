...
function AppointmentCard({ appointment }) {
    ...
    // Lấy tên bệnh nhân thay vì tên bác sĩ
    const patientName = appointment?.Patient?.User?.fullname || "Không rõ";
                ...
                <div className="flex items-start justify-between mb-5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            {/* Nếu muốn hiển thị thêm thông tin khác về bệnh nhân, thêm tại đây */}
                        </div>
                    </div>
